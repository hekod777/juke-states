...
juke.controller('ArtistsCtrl', function ($scope, $log, ArtistFactory) { //had root here
...
juke.controller('ArtistCtrl', function ($scope, $log, ArtistFactory, PlayerFactory) { //had root here
